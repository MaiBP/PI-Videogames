    ...
    <div className={Style.text}>
      <h3><MdOutlineWavingHand/>HELLO, I'M</h3> 
        ...
        <div className={Style.description}>
              <h4>Throughout my life and work career I've been involved in areas of development, teamwork and creativity. I was always curious, ambitious and determined to find solutions.</h4>
